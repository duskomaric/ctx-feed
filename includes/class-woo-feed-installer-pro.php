...
class Woo_Feed_Pro_Installer {
	...
	public static function install() {
		...
		//self::deactivate_free_version(); //moved to init function
		self::migrate_db();
	...
	private static function migrate_db() {
		...
		if ( version_compare( '3.3.10', WOO_FEED_PRO_VERSION, '<' ) ) {
			$keys = array( 'per_batch', 'product_query_type', 'currency_api_code', 'enable_error_debugging', 'woo_feed_cache_ttl' );
			$data = array();
			foreach ( $keys as $key ) {
...
Woo_Feed_Pro_Installer::init();
// End of file class-woo-feed-installer-pro.php
